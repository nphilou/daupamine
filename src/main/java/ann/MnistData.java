...
public class MnistData extends Application {
	...
	public static void main(String[] args) {
		if (args.length == 0) {
			try {
				Map<Input, Output> data = readData("src/main/resources/train-images-idx3-ubyte.gz",
								"src/main/resources/train-labels-idx1-ubyte.gz");
				Map<Input, Output> testSet = readData("src/main/resources/t10k-images-idx3-ubyte.gz",
								"src/main/resources/t10k-labels-idx1-ubyte.gz");
	...
	public void start(Stage primaryStage) throws Exception {
		...
		try {
			...
			data = readData("src/main/resources/train-images-idx3-ubyte.gz",
							"src/main/resources/train-labels-idx1-ubyte.gz");
			testSet = readData("src/main/resources/t10k-images-idx3-ubyte.gz",
							"src/main/resources/t10k-labels-idx1-ubyte.gz");
		} catch (IOException e) {
			e.printStackTrace();
		}
